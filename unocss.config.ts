...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    'gpt-subtitle': 'text-(2xl transparent) font-extrabold bg-(clip-text gradient-to-r) from-rose-300 to-rose-500',
    ...
    'sys-edit-btn': 'inline-fcc gap-1 text-sm bg-slate/10 px-4 py-1 rounded-full transition-colors cursor-pointer hover:bg-slate/50',
  }],
})
