...
import type { ChatMessage, Setting, User } from '@/types'
  ...
  return (
    <div>
      <Show when={props.messageList().length === 0}>
        <div
          class="flex cursor-pointer op-70 justify-end"
          onClick={() => {
      ...
      <Show when={props.showSetting()}>
        <div class="my-4 op-70">
          <div class="text-sm space-y-1">
            ...
            <div>
              <div>开关为连续对话开关</div>
              <div>开启理解对话上下文,但次数消耗快,每次问答<span class="text-[#42936d]">消耗累加</span>(最高5次)</div>
